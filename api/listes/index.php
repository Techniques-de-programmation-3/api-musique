  ...
  switch($_SERVER['REQUEST_METHOD']) { 
    ...
    case 'GET': 
      if(isset($_GET["id"])){
        ...
        $listes = $controleurListe->afficherListesUtilisateurJSON($_GET["utilisateur"]);
      } else {
    ...
    case 'POST':
      $controleurListe->ajouterJSON();
      break;


    case 'PUT':
      $controleurListe->editerJSON();
      break;

    case 'DELETE':
        $controleurListe->supprimerJSON(); 
        break;
    }
?>
