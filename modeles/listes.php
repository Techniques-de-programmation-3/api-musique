...
class modele_liste {
    ...
    public function __construct($id, $titre, $sousTitre, $image, $description, $type, $verifie, $datePublication, $visibilite) {
        ...
        $this->type = $type;
        $this->verifie = boolval($verifie);
        $this->datePublication = $datePublication;
        $this->visibilite = $visibilite;
        $this->chansons = modele_chanson::ObtenirListe($id);
    }
    ...
    public static function ObtenirUtilisateur($id_utilisateur) {
        ...
        $requete = $mysqli->prepare("SELECT listes.id as id, titre, soustitre, image, description, type, verifie, datePublication, visibilite FROM listes inner join listes_utilisateurs on listes.id = listes_utilisateurs.liste_id WHERE listes_utilisateurs.utilisateur_id = ? ORDER BY ordre;");
